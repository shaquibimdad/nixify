#!/usr/bin/env bash
# Autor: Thiago Silva, Anirudh Gupta
# Contact: thiagos.dasilva@gmail.com, anirudhgupta109@aosip.dev
# URL: https://github.com/anirudhgupta109/arch-change-gdm-background
# =================================================================== #
...
<gresources>
    ...
    echo 'Usage: sudo ./arch-change-gdm-background /path/to/image.*g'
    echo 'Usage: sudo ./arch-change-gdm-background \#yourhexcode'
